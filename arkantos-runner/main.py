...
# Player
player_img      = pygame.image.load('assets/idle.png').convert()
# Get rid of the white background
player_img.set_colorkey((WHITE))
player_rect     = player_img.get_rect(center = (50, 20))
moving_left     = False
moving_right    = False
air_timer = 0
player_y_momentum = 0
...
while True:
    ...
    display.blit(player_img, (player_rect.x - true_camera.x, player_rect.y - true_camera.y))
